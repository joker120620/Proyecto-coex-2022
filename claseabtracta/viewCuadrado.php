...
if (isset($_GET['lado'])) {
    $lado = $_GET['lado'];
    $cuadrado = new areaCuadrado($lado);
    $result = $cuadrado->obtenerDatos();
} else {
    $result = 0;
};
  ...
  <path d="M8.707 1.5a1 1 0 0 0-1.414 0L.646 8.146a.5.5 0 0 0 .708.708L2 8.207V13.5A1.5 1.5 0 0 0 3.5 15h9a1.5 1.5 0 0 0 1.5-1.5V8.207l.646.647a.5.5 0 0 0 .708-.708L13 5.793V2.5a.5.5 0 0 0-.5-.5h-1a.5.5 0 0 0-.5.5v1.293L8.707 1.5ZM13 7.207V13.5a.5.5 0 0 1-.5.5h-9a.5.5 0 0 1-.5-.5V7.207l5-5 5 5Z"/>
    ...
    <main>
        <section class="container d-flex flex-column justify-content-center border border-dark rounded p-4 w-25 text-center mt-4 bg-light">
            <h2>CUADRADO</h2>
            <form class="d-flex flex-column justify-content-center" action="./viewCuadrado.php" method="get">
                <label class="form-label mb-3" for="lado">lado</label>
                <input class="form-control mb-3" type=number name="lado">
                <input class="btn btn-dark " type=submit>
                <label class="form-label mt-2 bg-success text-light rounded-pill"> <?php echo $result ?> </label>
            </form>
        </section>
    </main>
